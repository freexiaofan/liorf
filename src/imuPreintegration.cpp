...
public:
    ...
    IMUPreintegration()
    {
        ...
        subOdometry = nh.subscribe<nav_msgs::Odometry>("liorf/mapping/odometry_incremental", 5000,    &IMUPreintegration::odometryHandler, this, ros::TransportHints().tcpNoDelay());
